...
import MailForwarding from "./pages/services/MailForwarding";
import PackageForwarding from "./pages/services/PackageForwarding";
import OnlineMailManagement from "./pages/services/OnlineMailManagement";
import Edmm from "./pages/services/Edmm";
import Fulfillment from "./pages/services/Fulfillment";
import RegisteredAgent from "./pages/services/RegisteredAgent";
import FormationService from "./pages/services/FormationService";
import TelFaxLine from "./pages/services/TelFaxLine";
...
const App = () => {
  let routes = useRoutes([
    ...
    { path: "/MailForwarding", element: <MailForwarding /> },
    { path: "/PackageForwarding", element: <PackageForwarding /> },
    { path: "/OnlineMailManagement", element: <OnlineMailManagement /> },
    { path: "/Edmm_dmm", element: <Edmm /> },
    { path: "/Fulfillment", element: <Fulfillment /> },
    { path: "/RegisteredAgent", element: <RegisteredAgent /> },
    { path: "/Company_Formation_Service", element: <FormationService /> },
    { path: "/Tel_Fax_Line", element: <TelFaxLine /> },
