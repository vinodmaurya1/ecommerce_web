        ...
        <div className="row">
          <div className="col-lg-12">
            <div className="group-title-counter stc">
              ...
              <p>About 80k+ new mails everyday</p>
            </div>
              ...
              <div className="row align-item-center">
                <div className="col-lg-3 col-md-6">
                  <div className="wd-counter widget-counter">
                    ...
                    <p className="description">Mails</p>
                  </div>
                </div>
                <div className="col-lg-3 col-md-6">
                  <div className="wd-counter widget-counter">
                    ...
                    <p className="description">Mails per day</p>
                  </div>
                </div>
                <div className="col-lg-3 col-md-6">
                  <div className="wd-counter widget-counter">
                    ...
                    <p className="description">Companies Contact</p>
                  </div>
                </div>
                <div className="col-lg-3 col-md-6">
                  <div className="wd-counter widget-counter br-none">
                    ...
                    <p className="description">Customers</p>
                  </div>
                </div>
              </div>
