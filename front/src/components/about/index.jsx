        ...
        <div className="row">
          ...
          <div className="col-lg-6 col-md-12 content-tab wow fadeInRight">
            <div className="wd-review-job contentbox1">
              <h3>Online Mail & Packages Management Services</h3>
              <p>
                Our services offer everything you need to manage mails and
                packages online. Use our online mail management platform to
                control your post from anywhere in the world, using and device,
                at anytime.
              </p>
              <ul className="wd-list-icon">
                <li>
                  ...
                  Start a new company with our company formation service
                </li>
                <li>
                  <span className="icon">
                    <svg
                ...
                <li>
                  ...
                  Use our USA postal addresses with mail scanning /forwarding
                </li>
                <li>
                  <span className="icon">
                    <svg
                  ...
                  Book a local phone number for incoming and outgoing calls
                </li>
                <li>
                  <span className="icon">
                    <svg
                  ...
                  All virtual Office Services can be managed digitally
                </li>
              </ul>
            </div>
          </div>
