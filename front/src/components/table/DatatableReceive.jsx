...
const ProductsData = [
  {
    ...
    description: "hsyur hdfjfd jhfiher fkjdf kdfjkfdj drkdfjdf kfdjkdfj",
  },
  {
...
const DatatableReceive = () => {
  ...
  const getProducts = notification?.data;
  ...
  // useEffect(() => {
  //   console.log("noti-new",notification)
  // }, [notification])
  ...
  const handleScan = (id) => {
    ...
    try {
      axios
        .post(
          `${api_url}/user/mail_action`,
          { mail_receive_id:`${id}`, open_scan: "1" },
          {
            headers: {
              Authorization: `Bearer ${logintoken}`,
            },
